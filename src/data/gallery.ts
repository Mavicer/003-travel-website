...
export const GALLERY_PHOTOS: GalleryPhoto[] = [
  ...
  {
    image: '/gallery/11-hangzhou.jpg',
    location: '杭州 · 中国',
    title: '西湖夜泊',
    story: '入夜后的西湖褪去了白日的游人喧嚣，湖心亭的灯火在水面上拉出长长的金色倒影。苏堤上的柳枝在晚风里轻轻摇摆，远处雷峰塔的轮廓被灯光勾勒得像一座发光的岛屿。坐在湖边的长椅上，什么也不想——杭州的夜晚只适合发呆。',
    mood: '温婉',
    category: '文化',
    imageRationale: '西湖夜景中的中式水榭 — 展现杭州不同于白日"湖光山色"的另一面：静谧、温柔、适合发呆的夜晚',
  },
  {
    image: '/gallery/12-faroe.jpg',
    location: '法罗群岛 · 北大西洋',
    title: '世界的尽头',
    story: '法罗群岛的房子不像房子——它们更像从草地里长出来的石头。混凝土墙面上留着风的纹路，草皮屋顶在暴雨后闪着湿润的光泽。推开窗，北大西洋的风灌进来，带着咸味和远处海鹦的鸣叫。这里没有"附近"，最近的城市在几百公里之外。',
    mood: '孤绝',
    category: '冒险',
    imageRationale: '法罗群岛混凝土房屋与水面 — 展现法罗人日常生活的朴素质感，与封面悬崖大景形成远近对比',
  },
];
