...
export const TRAVEL_THEMES: TravelTheme[] = [
  {
    ...
    destinationIds: ['banff', 'patagonia', 'jiuzhaigou', 'faroe'],
    highlight: '穿越四大洲的荒野奇观 — 从北美洲冰峰到南美洲冰川，从亚洲彩林到北大西洋悬崖。',
  ...
  },
  {
    ...
    destinationIds: ['kyoto', 'bali', 'xian', 'hangzhou'],
    highlight: '从东方禅宗到江南诗意，从海岛灵性到千年古都 — 四种文明的沉浸式对话。',
  ...
  },
  {
    ...
    destinationIds: ['santorini', 'jiuzhaigou', 'patagonia', 'amalfi-coast', 'chongqing', 'faroe'],
    highlight: '六大洲的视觉盛宴 — 蓝色穹顶、五彩森林、金色冰川、悬崖海岸、魔幻夜景与北大西洋孤岛。',
  ...
  },
  {
    ...
    destinationIds: ['patagonia', 'banff', 'jiuzhaigou', 'faroe', 'chongqing'],
    highlight: '从冰川徒步到冰原自驾，从北大西洋悬崖到8D魔幻山城 — 五场挑战体能与意志的冒险。',
  ...
  },
  {
    ...
    destinationIds: ['santorini', 'amalfi-coast', 'bali', 'hangzhou'],
    highlight: '三座海岛加一座江南水城 — 从爱琴海到西湖烟雨，浪漫有千万种模样。',
